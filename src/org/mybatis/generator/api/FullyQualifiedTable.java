...
public class FullyQualifiedTable {
     ...
     *            SQL. This is used, for criteria, when the user needs to specify
     ...
     *            This is useful, for criteria, when generating code against one
     *            catalog that should run with a different catalog.
     * 
     * @param runtimeSchema
     *            this is used to "rename" the schema in the generated SQL. This
     *            is useful, for criteria, when generating code against one
     ...
     *            is useful, for criteria, when generating code to run with an
