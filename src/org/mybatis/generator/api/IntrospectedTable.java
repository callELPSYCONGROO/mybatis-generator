...
public abstract class IntrospectedTable {
	...
	protected enum InternalAttribute {
		ATTR_DAO_IMPLEMENTATION_TYPE, ATTR_DAO_INTERFACE_TYPE, ATTR_PRIMARY_KEY_TYPE, ATTR_BASE_RECORD_TYPE, ATTR_RECORD_WITH_BLOBS_TYPE, ATTR_EXAMPLE_TYPE, ATTR_MODEL_TYPE, ATTR_IBATIS2_SQL_MAP_PACKAGE, ATTR_IBATIS2_SQL_MAP_FILE_NAME, ATTR_IBATIS2_SQL_MAP_NAMESPACE, ATTR_MYBATIS3_XML_MAPPER_PACKAGE, ATTR_MYBATIS3_XML_MAPPER_FILE_NAME,
	...
	public String getSelectByModelQueryId() {
		return tableConfiguration.getSelectByModelQueryId();
	}
	 ...
	 * and select by criteria with BLOBs methods)
	 * 
	...
	/**
	 * Returns all columns except BLOBs (for use by the select by criteria
	...
	/**
	 * 
	 * @return the type for the criteria class.
	 */
	...
	protected void calculateXmlAttributes() {
		...
		setSelectByModelWithBLOBsStatementId("selectByModelWithBLOBs"); //$NON-NLS-1$
		...
		setCriteriaWhereClauseId("Criteria_Where_Clause"); //$NON-NLS-1$
	...
	public void setCriteriaWhereClauseId(String s) {
		internalAttributes.put(InternalAttribute.ATTR_EXAMPLE_WHERE_CLAUSE_ID, s);
	}

	public void setModelWhereClauseId(String s) {
		internalAttributes.put(InternalAttribute.ATTR_MODEL_WHERE_CLAUSE_ID, s);
	}
	...
	public void setMyBatis3UpdateByModelWhereClauseId(String s) {
		internalAttributes.put(InternalAttribute.ATTR_MYBATIS3_UPDATE_BY_MODEL_WHERE_CLAUSE_ID, s);
	}
	...
	public void setSelectByModelWithBLOBsStatementId(String s) {
		internalAttributes.put(InternalAttribute.ATTR_SELECT_BY_MODEL_WITH_BLOBS_STATEMENT_ID, s);
	}
	...
	public void setSelectByModelStatementId(String s) {
		internalAttributes.put(InternalAttribute.ATTR_SELECT_BY_MODEL_STATEMENT_ID, s);
	}
	...
	public void setCountByModelStatementId(String s) {
		internalAttributes.put(InternalAttribute.ATTR_COUNT_BY_MODEL_STATEMENT_ID, s);
	}
	...
	public String getCriteriaWhereClauseId() {
		return internalAttributes.get(InternalAttribute.ATTR_EXAMPLE_WHERE_CLAUSE_ID);
	}

	public String getModelWhereClauseId() {
		return internalAttributes.get(InternalAttribute.ATTR_MODEL_WHERE_CLAUSE_ID);
	}
	...
	public String getMyBatis3UpdateByModelWhereClauseId() {
		return internalAttributes.get(InternalAttribute.ATTR_MYBATIS3_UPDATE_BY_MODEL_WHERE_CLAUSE_ID);
	}
	...
	public String getSelectByModelWithBLOBsStatementId() {
		return internalAttributes.get(InternalAttribute.ATTR_SELECT_BY_MODEL_WITH_BLOBS_STATEMENT_ID);
	}
	...
	public String getSelectByModelStatementId() {
		return internalAttributes.get(InternalAttribute.ATTR_SELECT_BY_MODEL_STATEMENT_ID);
	}
	...
	public String getCountByModelStatementId() {
		return internalAttributes.get(InternalAttribute.ATTR_COUNT_BY_MODEL_STATEMENT_ID);
	}
	...
	public void setCriteriaType(String criteriaType) {
		internalAttributes.put(InternalAttribute.ATTR_EXAMPLE_TYPE, criteriaType);
	}
