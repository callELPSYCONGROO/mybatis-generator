...
public interface Plugin {
     ...
     * <p>
     * A good criteria of overriding an attribute would be the case where a user
     ...
     * changed by one of the other plugin methods. For criteria, if you want to
     * change the name of a generated criteria class, you should not simply
     * change the Type in the <code>modelCriteriaClassGenerated()</code> method.
     ...
     * it can run or not. For criteria, if the plugin requires certain properties
     * to be set, and the properties are not set, then the plugin is invalid and
     * will not run.
     * 
     * @param warnings
     *            add strings to this list to specify warnings. For criteria, if
     ...
     *         plugins.
     */
    boolean clientSelectByModelWithBLOBsMethodGenerated(Method method,
    		TopLevelClass topLevelClass, IntrospectedTable introspectedTable);
    ...
    /**
     * This method is called when the selectByModelWithoutBLOBs method has
     * been generated in the client implementation class.
     * 
     * @param method
     *            the generated selectByCriteriaWithoutBLOBs method
     ...
     *         plugins.
     */
    boolean clientSelectByModelWithoutBLOBsMethodGenerated(Method method,
    		TopLevelClass topLevelClass, IntrospectedTable introspectedTable);
    ...
    /**
     * This method is called after the criteria class is generated by the 
     * JavaModelGenerator. This method will only be called if the table
     * rules call for generation of an criteria class.
     * <p/>
     * This method is only guaranteed to be called by the default Java
     * model generators. Other user supplied generators may, or may not, call
     * this method.
     ...
     *         plugins.
     */
    boolean modelCriteriaClassGenerated(TopLevelClass topLevelClass,
            IntrospectedTable introspectedTable);
    ...
    /**
     * This method is called when the criteriaWhereClause element is generated.
     * 
     * @param element
     ...
     *         plugins.
     */
    boolean sqlMapCriteriaWhereClauseElementGenerated(XmlElement element,
            IntrospectedTable introspectedTable);
    ...
    /**
     * This method is called when the selectByModel element is generated.
     * 
     * @param element
     *            the generated &lt;select&gt; element
     * @param introspectedTable
     ...
     *         plugins.
     */
    boolean sqlMapSelectByModelWithoutBLOBsElementGenerated(
    		XmlElement element, IntrospectedTable introspectedTable);
     ...
     *         plugins.
     */
    boolean sqlMapSelectByModelWithBLOBsElementGenerated(XmlElement element,
    		IntrospectedTable introspectedTable);
