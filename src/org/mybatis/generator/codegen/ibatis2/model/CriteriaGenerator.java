...
public class CriteriaGenerator extends AbstractJavaGenerator {
    ...
    public CriteriaGenerator(boolean generateForJava5) {
        super();
    ...
    public List<CompilationUnit> getCompilationUnits() {
        ...
        // criteria methods are enabled - because the parameter
        // class for update by criteria methods will subclass this class
        ...
        if (context.getPlugins().modelCriteriaClassGenerated(
