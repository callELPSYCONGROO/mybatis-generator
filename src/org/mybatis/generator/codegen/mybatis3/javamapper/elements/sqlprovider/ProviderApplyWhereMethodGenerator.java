...
public class ProviderApplyWhereMethodGenerator extends
    ...
    private static final String[] methodLines = {
        ...
        "if (includeCriteriaPhrase) {", //$NON-NLS-1$
    ...
    public void addClassElements(TopLevelClass topLevelClass) {
        ...
        FullyQualifiedJavaType fqjt = new FullyQualifiedJavaType(introspectedTable.getCriteriaType());
        ...
        method.addParameter(new Parameter(FullyQualifiedJavaType.getBooleanPrimitiveInstance(), "includeCriteriaPhrase")); //$NON-NLS-1$
