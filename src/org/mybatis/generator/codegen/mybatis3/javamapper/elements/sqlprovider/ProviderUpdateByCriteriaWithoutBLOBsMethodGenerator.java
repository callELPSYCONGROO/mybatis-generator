...
public class ProviderUpdateByCriteriaWithoutBLOBsMethodGenerator extends
    ...
    public ProviderUpdateByCriteriaWithoutBLOBsMethodGenerator() {
        super();
    }
    ...
    public void addClassElements(TopLevelClass topLevelClass) {
        ...
        FullyQualifiedJavaType criteria =
            new FullyQualifiedJavaType(introspectedTable.getCriteriaType());
        importedTypes.add(criteria);
        method.addBodyLine(String.format("%s criteria = (%s) parameter.get(\"criteria\");", //$NON-NLS-1$
                criteria.getShortName(), criteria.getShortName()));
