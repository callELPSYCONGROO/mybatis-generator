...
public class ModifyInterfaceReturn {

	public static void main(String[] args) {
		// TODO Auto-generated method stub

		String javaFilePath = "D:/distributed/clsp/common-interface/src/main/java/com/jhrz/clsp/common/interfaces/weixin/";
		String[] files = new File(javaFilePath).list();
		//String[] files = { "SubscribeUserService.java" };
